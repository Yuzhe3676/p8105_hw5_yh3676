...
- The sample average of μ_hat across tests for which the null is
  ...
  most of the samples will have null rejected and the average estimate
  will approximately equal to the true value of μ.
